<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FailFile.aspx.cs" Inherits="FailFile" %>
...
<script language="JavaScript">
    ...
    <table style="margin-left:200px; margin-right:auto;">
      ...
      <td align="center" width="120" height="5"><div align="center"><strong>当前用户信息</strong></div></td>
         <td width="200" height="5"><strong>正在查看不通过文件...</strong><div align="center"></div></td>
       </tr>
       <tr>
        <td style="left">
            <table>
        ...
        <td style="right">      
            <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" 
                ...
                Height="53px" Width="422px" DataKeyNames="id" 
       ...
       <tr>
        <td>
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                SelectMethod="GetAllTFileU" TypeName="BLL.FileBL" 
